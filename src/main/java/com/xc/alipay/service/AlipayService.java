...
import com.xc.alipay.types.ClientType;
...
public class AlipayService {
	...
	public String payJump(AlipayTradeWapPayModel alipayTradeWapPayModel, ClientType clientType) {
		AlipayClient alipayClient = new DefaultAlipayClient(alipayUrl, alipayAppid, alipayAppPrivateKey, "json",
				CHARSET, alipayPublicKey, "RSA2"); // 获得初始化的AlipayClient
		String form = "";
