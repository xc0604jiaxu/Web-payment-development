...
public class JavaTools extends StringFunction {
	...
	public final static String numToIpString(long ip) {
		return new StringBuffer().append((ip >> 24) & 0xFF).append('.').append((ip >> 16) & 0xFF).append('.')
	 ...
	 */
	/*
	 * public final static String[] ToTypeList(String str) { return
	 * splitToList(str); }
	 */
	...
	public final static byte[] inputStreamToByteArray(InputStream in, long maxLength, boolean closeIn) {
		if (in != null && maxLength != 0) {
			...
			try {
				...
				for (int nbyte = 0, allbyte = 0; (maxLength <= 0 || allbyte < maxLength)
						&& (nbyte = in.read(b)) >= 0; allbyte += nbyte) {
					if (nbyte > 0)
						out.write(b, 0, nbyte);
					else
						Thread.sleep(1);
	 ...
	 */
	public final static Method getClassMethod(String className, String methodName, Object[] parameters,
			boolean caseParametersInstance) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public final static Object runClassMethod(String className, String methodName, Object[] parameters)
	...
	public final static Object runClassMethod4(Object classObject, String className, String methodName,
	 ...
	 */
	public final static Object runClassMethod4(Object classObject, String className, String methodName,
			Object[] parameters, boolean caseParametersInstance)
			throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		if (stringIsNotNull(className, methodName)) {
	 ...
	 * @throws InvocationTargetException
	 */
	public final static Object runClassMethod2(String classAndMethodName, Object[] parameters)
			throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
	 ...
	 * @return
	 */
	public static <T> T cacheRunMethod(Object classObject, String method, long cacheTime, Class<T> valueType,
			Object... args) {
		return null;
	}
